...
export interface OwnedUpgradeabilityStorageInterface extends Interface {
  getFunction(nameOrSignature: "upgradeabilityOwner"): FunctionFragment;
...
export interface OwnedUpgradeabilityStorage extends BaseContract {
  connect(runner?: ContractRunner | null): OwnedUpgradeabilityStorage;
